...
public interface IProcessService {
	 ...
	 * @param id 流程定义id
	 * @param type 类别
	 * @param modificator 修改中
	 */
	void updateType(String id, String type, String modificator);
	...
	String deployForFile(String xml);
	 ...
	 * @param id 流程定义id
	 * @param input 流程定义输入流
	 * @param modificator 修改者
	 */
	void redeploy(String id, InputStream input, String modificator);
	
	/** 根据字符串部署流程定义
	 * @param id 流程定义id
	 * @param xml xml格式的字符串
	 */
	void redeployForFile(String id, String xml);
	 ...
	 * @param modificator 修改者
	 */
    void redeployForFile(String id, String xml, String modificator);
	 ...
	 * @param id 流程定义id
	 */
	void undeploy(String id, String modificator);
