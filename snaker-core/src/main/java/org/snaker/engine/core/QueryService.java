...
public class QueryService extends AccessService implements IQueryService {
	...
	public HistoryOrderBo getHistOrderBo(String orderId) {
		return access().getHistOrderBo(orderId);
	}
	...
	public List<HistoryOrder> getHistoryOrders(Page<HistoryOrder> page, QueryFilter filter) {
		AssertHelper.notNull(filter);
		List<HistoryOrder> list = access().getHistoryOrders(page, filter);
		return list;
	}
	
	public List<HistoryOrderBo> getHistoryOrderBos(Page<HistoryOrderBo> page, QueryFilter filter) {
		AssertHelper.notNull(filter);
		List<HistoryOrderBo> list = access().getHistoryOrderBos(page, filter);
		return list;
	}
