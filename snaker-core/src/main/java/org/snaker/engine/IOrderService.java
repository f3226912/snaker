...
public interface IOrderService {
	 ...
	 * 流程实例正常完成
	 * @param orderId 流程实例id
	 * @param remark 存入历史的备注信息 
	 */
	void complete(String orderId, String remark);
	 ...
	 * @param orderId 流程实例id
	 * @param remark 流程实例终止备注信息
	 */
	void terminate(String orderId, String remark);
	
	/**
	 * 流程实例强制终止,并根据operator处理人员强制完成活动任务。
	 * @param orderId 流程实例id
	 * @param operator 处理人员 如果没有完成活动任务的权限，可能会抛出异常。
	 * @param remark 流程实例终止备注信息
	 */
	void terminate(String orderId, String operator, String remark);
